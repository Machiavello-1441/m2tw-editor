          ...
          <div className="w-full lg:w-64 flex flex-col gap-3 shrink-0">
            ...
            <div className="bg-slate-900 rounded-xl border border-slate-700 p-4 space-y-2">
              ...
              <div className="space-y-1 text-[11px]">
                ...
                {current.skeletonData?.joints?.length > 0 && (
                  <div className="flex justify-between"><span className="text-slate-500">Joints</span><span className="text-slate-200 font-mono">{current.skeletonData.joints.length}</span></div>
                )}
              </div>
            </div>
