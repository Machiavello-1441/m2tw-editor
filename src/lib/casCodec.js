...
// The `.mesh` and `.cas` readers that used to sit here were removed — their
// spec was invented and matched no real game file. Use @/lib/m2MeshCodec and
// @/lib/m2CasCodec instead.
