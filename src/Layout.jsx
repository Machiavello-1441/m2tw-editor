...
import { Castle, Download, Home, Shield, Package, Code2, Swords, Map, Globe, Volume2, FileText, ScrollText, Users } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'Characters', icon: Swords, page: 'CharactersEditor' },
  { name: 'Cmp Settings', icon: Globe, page: 'CampaignSettings' },
  { name: 'Factions', icon: Shield, page: 'FactionsEditor' },
  { name: 'Characters', icon: Users, page: 'CharactersEditor' },
  { name: 'Cmp Settings', icon: Globe, page: 'CampaignSettings' },
